...
public class CommercialFlight extends NonPrivateFlight{
    ...
    public CommercialFlight(String flightNumber, Airport source, Airport destination, Date scheduledDepart, Date scheduledArriv, Date actualDepart, Date actualArriv, Aircraft plane, Airline operator) {
